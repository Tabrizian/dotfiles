...
" Templates {{{
autocmd BufNewFile *solution.tex  0r ~/Templates/homework.tex
autocmd BufNewFile *report.tex 0r ~/Templates/report.tex
autocmd BufNewFile *.vhd 0r ~/Templates/default.vhd
